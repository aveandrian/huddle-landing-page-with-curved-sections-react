...
function App() {
  ...
  return (
    ...
    <section className='header-section'>
      ...
      <img className='header-img' src='/images/screen-mockups.svg'></img>
    </section>
    <section className='stats-section'>
      <div className='stats-item'>
        <img className='stats-img' src='/images/icon-communities.svg'/>
        <h1 className='stats-number'>1.4k+</h1>
        <p className='stats-text'>Communities Formed</p>
      </div>
      <div className='stats-item'>
        <img className='stats-img' src='/images/icon-messages.svg'/>
        <h1 className='stats-number'>2.7m+</h1>
        <p className='stats-text'>Messages Sent</p>
      </div>
    </section>
    <section className='grow-section'>
      <img className='grow-img' src='/images/illustration-grow-together.svg'></img>
    ...
    <section className='flowing-section'>
      <img className='flowing-img' src='/images/illustration-flowing-conversation.svg'></img>
    ...
    <section className='users-section'>
      <img className='users-img' src='/images/illustration-your-users.svg'></img>
    ...
    <section className='footer-section'>
      <div className='footer-contacts'>
        ...
        <div className='contact-item'>
          <img className='contact-icon' src='/images/icon-phone.svg'></img>
          <p className='contact-text'>Phone: +1-543-123-4567</p>
        </div>
        <div className='contact-item'>
          <img className='contact-icon' src='/images/icon-email.svg'></img>
